...
trait FileUploader {
    ...
    public function deleteMedia($directory, $model) {
        ...
        $attach_base = base_path('uploads/'.$directory.'/'.$model->attach);
        if(File::isFile($attach_base)){
            File::delete($attach_base);
        }
    ...
    /**
     * Upload multiple media file to the specified directory.
     * @param Request $request
     */
    public function updateMultiMedia(Request $request, $attach, $directory, $model, $field) {
        ...
        if($request->hasFile($attach)){
            ...
            $old_attach_base = base_path('uploads/'.$directory.'/'.$model->$field);
            if(File::isFile($old_attach_base)){
                File::delete($old_attach_base);
            }
    ...
    /**
     * Delete multiple media file from the specified directory.
     * @param Request $request
     */
    public function deleteMultiMedia($directory, $model, $field) {
        ...
        $attach_base = base_path('uploads/'.$directory.'/'.$model->$field);
        if(File::isFile($attach_base)){
            File::delete($attach_base);
        }
    ...
    /**
     * Upload image file to the specified directory with resizing.
     * @param Request $request
     */
    ...
    /**
     * Update image file in the specified directory with resizing.
     * @param Request $request
     */
