...
class ApplicationSettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($id == -1){
            ...
            $applicationSetting->fee_amount = $request->fee_amount;
            $applicationSetting->pay_online = $request->pay_online ?? 0;
            $applicationSetting->send_applicant_email = $request->send_applicant_email ?? 0;
            $applicationSetting->notify_university_email = $request->notify_university_email ?? 0;
