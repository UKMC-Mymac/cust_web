...
class NoticeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (! empty($request->category) || $request->category != null) {
            $rows->whereHas('categories', function ($q) use ($category) {
                $q->where('notice_categories.id', $category);
            });
        }
        $data['rows'] = $rows->orderBy('date', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'categories.*' => 'required|integer|exists:notice_categories,id',
        ...
        try {
            ...
            $notice->category_id = $request->categories[0] ?? null;
            ...
            $notice->categories()->sync($request->categories);
