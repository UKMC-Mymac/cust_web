...
class TestimonialController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Testimonial::where('language_id', Language::version()->id);
    ...
    public function store(Request $request)
    {
        ...
        $testimonial->attach = $this->uploadImage($request, 'attach', $this->path, 570, 670);
        $testimonial->save();
    ...
    public function update(Request $request, Testimonial $testimonial)
    {
        ...
        $testimonial->description = $request->description;
        $testimonial->rating = $request->rating ?? 5;
        $testimonial->attach = $this->updateImage($request, 'attach', $this->path, 570, 670, $testimonial, 'attach');
