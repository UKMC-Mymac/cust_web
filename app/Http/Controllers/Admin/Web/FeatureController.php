...
class FeatureController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['rows'] = Feature::query()->where('language_id', Language::version()->id)
                        ->orderby('id', 'asc')
                        ->get();
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'program_language' => 'nullable|string|max:255',
        ...
        $feature->program_language = $request->program_language;
        $feature->duration = $request->duration;
    ...
    public function destroy(Feature $feature)
    {
        ...
        //Delete Data
        Feature::query()->whereKey($feature->id)->delete();
