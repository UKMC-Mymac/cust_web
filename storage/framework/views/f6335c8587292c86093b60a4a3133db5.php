...
<?php $__env->startSection('title', 'Academic Calendars'); ?>
    ...
    <div class="container">
                ...
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div>
                        <h3 class="fw-bold mb-0">
                            <?php echo e(__('Academic Calendars')); ?>

                        </h3>
                        <small class="text-muted">
                            <?php echo e(__('Search and view publication of academic calendars')); ?>
        ...
        <div class="card border rounded-3 shadow-sm mb-4">
            <div class="card-body p-4">
                <form method="GET" action="<?php echo e(route('academic-calendar')); ?>">
                        ...
                        <div class="col-md-3 d-flex gap-2">
                            <button type="submit" class="btn btn-primary w-100 py-2">
                             ...
                             <?php if($selected_session): ?>
                                <a href="<?php echo e(route('academic-calendar')); ?>" class="btn btn-outline-secondary py-2" title="Reset Filters">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="text-center py-5">
                    ...
                    <h5 class="fw-bold mb-2">
                        <?php echo e(__('No Academic Calendars Found')); ?>
...
<?php echo $__env->make('web.custom.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cust_web\resources\views/web/academic-calendar.blade.php ENDPATH**/ ?>