                    ...
                    <div class="swiper-slide">
                        <div class="hero-inner">
                            <div class="th-hero-bg"
                                data-bg-src="<?php echo e(asset('uploads/slider/' . ($slider->attach ?? ''))); ?>"></div>
                                ...
                                <div class="hero-style1">
                                    <div class="hero-text-wrap">
                                        ...
                                        <h1 class="hero-title text-white" data-ani="slideinup" data-ani-delay="0.3s">
                                            ...
                                            <?php if($titleAccent): ?>
                                                <span class="accent"><?php echo e($titleAccent); ?></span>
                                            <?php endif; ?>
                                        </h1>

                                        <?php if(!empty($slider->sub_title)): ?>
                                            <p class="hero-quote text-white" data-ani="slideinup" data-ani-delay="0.5s">
                                                <?php echo strip_tags($slider->sub_title ?? '', '<b><u><i><em><br>'); ?>

                                            </p>
                                        <?php endif; ?>

                                        <?php if(!empty($slider->short_description ?? null)): ?>
                                            ...
                                            <?php if(!empty($primaryButtonUrl) || !empty($secondaryButtonUrl)): ?>
                                                <?php if(!empty($primaryButtonUrl)): ?>
                                                    <a href="<?php echo e($primaryButtonUrl); ?>"
                                                        ...
                                                        <?php echo e($slider->button_text ?? 'Apply Now'); ?>
                                                ...
                                                <?php if(!empty($secondaryButtonUrl)): ?>
                                                    <a href="<?php echo e($secondaryButtonUrl); ?>"
                                                        ...
                                                        <?php echo e($slider->button_text_2 ?? 'Explore Programs'); ?>
