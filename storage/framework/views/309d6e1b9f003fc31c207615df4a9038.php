<!-- jQuery -->
<script src="<?php echo e(asset('dist/js/vendor/jquery-3.7.1.min.js')); ?>"></script>
...
<!-- Magnific Popup -->
<script src="<?php echo e(asset('dist/js/jquery.magnific-popup.min.js')); ?>"></script>

<!-- Counter Up -->
<script src="<?php echo e(asset('dist/js/jquery.counterup.min.js')); ?>"></script>

<!-- Range Slider -->
<script src="<?php echo e(asset('dist/js/jquery-ui.min.js')); ?>"></script>

<!-- Isotope Filter -->
<script src="<?php echo e(asset('dist/js/imagesloaded.pkgd.min.js')); ?>"></script>
<script src="<?php echo e(asset('dist/js/isotope.pkgd.min.js')); ?>"></script>

<!-- Wow JS -->
<script src="<?php echo e(asset('dist/js/wow.min.js')); ?>"></script>

<!-- GSAP Animation -->
<script src="<?php echo e(asset('dist/js/gsap.min.js')); ?>"></script>

<!-- ScrollTrigger -->
<script src="<?php echo e(asset('dist/js/ScrollTrigger.min.js')); ?>"></script>

<!-- SplitText -->
<script src="<?php echo e(asset('dist/js/SplitText.min.js')); ?>"></script>

<!-- Lenis JS -->
<script src="<?php echo e(asset('dist/js/lenis.min.js')); ?>"></script>
...
<script>
	(() => {
		...
		const pusherKey = <?php echo json_encode(config('broadcasting.connections.pusher.key'), 15, 512) ?>;
		const pusherCluster = <?php echo json_encode(config('broadcasting.connections.pusher.options.cluster'), 15, 512) ?>;
		...
		function loadMessages(chatId) {
			return api('<?php echo e(url('chat')); ?>/' + encodeURIComponent(chatId) + '/messages').then(function (data) {
		...
		function ensureSession() {
			return api('<?php echo e(route('chat.session')); ?>', {
				method: 'POST',
				headers: {
		...
		function leaveChat() {
			...
			api('<?php echo e(url('chat')); ?>/' + encodeURIComponent(currentChatId) + '/leave', {
				method: 'POST'
			}).finally(function () {
				currentChatId = null;
		...
		function startNewChat() {
			...
			return api('<?php echo e(url('chat')); ?>/' + encodeURIComponent(currentChatId) + '/leave', {
				method: 'POST'
			}).finally(function () {
				currentChatId = null;
				localStorage.removeItem(storageKey);
		...
		function sendMessage() {
			...
			api('<?php echo e(url('chat')); ?>/' + encodeURIComponent(currentChatId) + '/message', {
				method: 'POST',
				headers: {
					'Content-Type': 'application/json'
				},
...
<?php /**PATH C:\laragon\www\cust_web\resources\views/web/custom/components/scripts.blade.php ENDPATH**/ ?>