    ...
    <script src="<?php echo e(asset('plugins/popper/js/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('plugins/bootstrap/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('plugins/jquery-scrollbar/js/perfect-scrollbar.min.js')); ?>"></script>
    ...
    (function () {
        ...
        <?php
            $editorPages = \App\Models\Web\Page::query()
                ...
                ->get(['id', 'title', 'slug']);
        ?>
        window.pageLinkPages = <?php echo json_encode($editorPages, 15, 512) ?>;
        ...
        var isRtl = <?php echo json_encode(optional($activeLanguage)->direction == 1, 15, 512) ?>;
        var pageLinkRouteTemplate = <?php echo json_encode(route('page.single', ['slug' => '__PAGE_SLUG__'], false)) ?>;
        var memberRouteTemplate = <?php echo json_encode(route('members.single', ['slug' => '__MEMBER_SLUG__'], false)) ?>;
        var editorMembers = <?php echo json_encode($editorMembers, 15, 512) ?>;
        var memberFallbackImage = <?php echo json_encode(asset('dist/images/fallback_member.jpg'), 15, 512) ?>;
                ...
                editor.ui.registry.addButton('uploadFile', {
                    ...
                    onAction: function () {
                        ...
                        fileInput.onchange = function () {
                            ...
                            xhr.open('POST', '<?php echo e(route('admin.page.upload')); ?>');
        ...
        tinymce.init({
            ...
            language: '<?php echo e(optional($activeLanguage)->code ?? "en"); ?>',
            height: 540,
...
<?php /**PATH D:\office_project\cust\resources\views/admin/layouts/common/footer_script.blade.php ENDPATH**/ ?>