            ...
            <div class="col-md-12">
                <div class="card border-info">
                    ...
                    <div class="card-block">
                        @php
                            $testimonialSection = \App\Models\Web\ContentSection::query()
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-2">
                                    ...
                                    <span class="text-muted">{{ $testimonialSection->subtitle ?? 'Not set' }}</span>
                                </div>
                                <div class="mb-2">
                                    <strong>Title:</strong> 
                                    <span class="text-muted">{{ $testimonialSection->title ?? 'Not set' }}</span>
                                </div>
                                <div>
                                    <strong>Description:</strong> 
                                    <span class="text-muted">{!! str_limit($testimonialSection->description ?? 'Not set', 100) !!}</span>
                                </div>
                            </div>
                            <div class="col-md-4 text-end">
                                @if($testimonialSection && $testimonialSection->status == 1)
                                ...
                                @endif
                                <a href="{{ route('admin.content-section.manage', 'testimonial') }}" class="btn btn-info">
                ...
                @csrf
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group ">
                                <label for="attach">{{ __('field_photo') }} <span>{{ __('image_size', ['height' => 670, 'width' => 570]) }}</span> <span>*</span></label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <form method="GET" action="{{ route($route.'.index') }}" class="d-flex justify-content-end">
                                    <input type="text" name="search" class="form-control" placeholder="Search name or designation..." value="{{ request()->get('search') }}" style="width: 250px; margin-right: 8px;">
