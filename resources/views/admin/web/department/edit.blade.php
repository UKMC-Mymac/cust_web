                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" name="school" id="school" required>
                                ...
                                <option value="{{ $school->id }}" @if($row->school_id == $school->id) selected @endif>{{ $school->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" name="short_description" id="short_description" rows="4">{{ $row->short_description }}</textarea>
                        </div>
                        <!-- Form End -->
                      </div>
                    </div>
