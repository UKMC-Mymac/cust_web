                ...
                <div class="card">
                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="feature_text">{{ __('field_feature_text') }}</label>
                            <textarea class="form-control" name="feature_text" id="feature_text" rows="3">{{ old('feature_text') }}</textarea>
                        ...
                        <div class="form-group col-md-4">
                            <label for="time">{{ __('field_time') }}</label>
                            <input type="time" class="form-control time" name="time" id="time" value="{{ old('time') }}">
                        ...
                        <div class="form-group col-md-4">
                            <label for="pinned">{{ __('field_pinned') }}</label>
                            <input type="number" class="form-control" name="pinned" id="pinned" value="{{ old('pinned') }}" min="1" step="1">

                            <div class="invalid-feedback">
                              {{ __('required_field') }} {{ __('field_pinned') }}
                            </div>
                        </div>

                        <div class="form-group col-md-8">
                            <label for="attach">{{ __('field_thumbnail') }}: <span>{{ __('image_size', ['height' => 400, 'width' => 650]) }}</span> <span>*</span></label>
