                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <textarea class="form-control" name="feature_text" id="feature_text" rows="3">{{ $row->feature_text }}</textarea>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="time" class="form-control time" name="time" id="time" value="{{ $row->time }}">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control" name="pinned" id="pinned" value="{{ $row->pinned }}" min="1" step="1">
                        ...
                        <div class="form-group col-md-8">
                            <label for="attach">{{ __('field_thumbnail') }}: <span>{{ __('image_size', ['height' => 400, 'width' => 650]) }}</span></label>
