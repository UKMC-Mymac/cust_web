                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control texteditor" name="short_description" id="short_description" required>{{ old('short_description') }}</textarea>

                            <div class="invalid-feedback">
                              {{ __('required_field') }} Short Description
                            </div>
                        </div>
