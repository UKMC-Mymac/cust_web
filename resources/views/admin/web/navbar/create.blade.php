                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="parent_id" id="parent_id">
                                ...
                                @foreach ($parents as $parent)
                                    <option value="{{ $parent->id }}" @if(old('parent_id') == $parent->id) selected @endif>{{ $parent->label }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="page_id" id="page_id">
                                ...
                                @foreach ($pages as $page)
                                    <option value="{{ $page->id }}" @if(old('page_id') == $page->id) selected @endif>{{ $page->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" name="route_name" id="route_name">
                                ...
                                @foreach (config('navbars.internal_links', []) as $routeName => $label)
                                    <option value="{{ $routeName }}" @if(old('route_name') == $routeName) selected @endif>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="url" id="url" value="{{ old('url') }}" placeholder="https://example.com">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="target" id="target">
                                <option value="_self" @if(old('target', '_self') == '_self') selected @endif>Same Tab</option>
                                <option value="_blank" @if(old('target') == '_blank') selected @endif>New Tab</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="status" id="status">
                                <option value="1" @if(old('status', 1) == 1) selected @endif>{{ __('status_active') }}</option>
