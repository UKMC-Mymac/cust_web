                    ...
                    <div class="card-block">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="url" class="form-control" name="video_url" id="video_url" value="{{ old('video_url', $row->video_url) }}" placeholder="https://www.youtube.com/watch?v=...">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="url" class="form-control" name="button_link" id="button_link" value="{{ old('button_link', $row->button_link) }}" placeholder="https://example.com">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="button_text_2" id="button_text_2" value="{{ old('button_text_2', $row->button_text_2) }}">
                        </div>
                            ...
                            <div class="row g-2">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="page_id_2" id="page_id_2">
                                        <option value="">Select Page</option>
                                        @foreach($pages as $page)
                                            <option value="{{ $page->id }}" @selected(old('page_id_2', $row->page_id_2 ?? '') == $page->id)>{{ $page->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control" name="route_name_2" id="route_name_2">
                                        <option value="">Select Internal Link</option>
                                        @foreach($internalRoutes as $routeName => $label)
                                            <option value="{{ $routeName }}" @selected(old('route_name_2', $row->route_name_2 ?? '') == $routeName)>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <label for="button_link_2">Custom URL</label>
                                    <input type="url" class="form-control" name="button_link_2" id="button_link_2" value="{{ old('button_link_2', $row->button_link_2) }}" placeholder="https://example.com">
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
