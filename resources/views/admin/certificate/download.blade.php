...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/prints/certificate.css') }}" media="screen, print">
...
<div class="template-container" id="downloadable" style="border-image: url('{{ asset('uploads/'.$path.'/'.$certificate->template->background) }}') 30 stretch; width: {{ $certificate->template->width }}; height: {{ $certificate->template->height }};">
    ...
    <script type="text/javascript">
        "use strict";
        var pdf_title =  '{{ $certificate->template->title }}-{{ $certificate->serial_no }}' + '.pdf'
