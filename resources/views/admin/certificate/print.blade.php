...
<div class="template-container printable" style="border-image: url('{{ asset('uploads/'.$path.'/'.$certificate->template->background) }}') 30 stretch; width: {{ $certificate->template->width }}; height: {{ $certificate->template->height }};">
