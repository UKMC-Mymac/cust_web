        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="template-container" style="border-image: url('{{ asset('uploads/'.$path.'/'.$row->background) }}') 30 stretch; width: {{ $row->width }}; height: {{ $row->height }};">
                                ...
                                <tr>
                                    ...
                                    <td class="temp-logo last">
                                      <div class="inner">
                                        ...
                                        <img src="{{ asset('images/user/avatar-2.jpg') }}" alt="Student">
                                        @endif
                                      </div>
                                    </td>
                                </tr>
