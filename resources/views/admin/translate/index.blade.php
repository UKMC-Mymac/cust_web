...
<head>
    ...
    <!-- RTL css -->
    <link rel="stylesheet" href="{{ asset('css/layouts/rtl.css') }}" type="text/css" media="screen, print">
    @endif
    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light headerpos-fixed header-lightblue">
        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li>
                    <div class="dropdown">
                        <a class="dropdown-toggle" href="#" data-toggle="dropdown" style="position: relative;">
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="{{ asset('uploads/user/'.Auth::user()->photo) }}" class="img-radius" alt="User Profile" onerror="this.src='{{ asset('images/user/avatar-2.jpg') }}';">
