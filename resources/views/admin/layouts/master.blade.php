                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                @endphp
                                @forelse($filteredNotifications as $key => $notification)
                                @if($key < 10)
                                @php
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="{{ asset('uploads/user/'.Auth::user()->photo) }}" class="img-radius" alt="User Profile" @if(Auth::user()->gender == 1) onerror="this.src='{{ asset('images/user/avatar-2.jpg') }}';" @else  onerror="this.src='{{ asset('images/user/avatar-1.jpg') }}';" @endif>
