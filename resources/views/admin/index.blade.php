            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                ...
                <div class="card bg-c-blue bitcoin-wallet">
                    <div class="card-block">
                        ...
                        <h2 class="text-white mb-2 f-w-300">{{ $approved_applications->count() }}</h2>
            ...
            <div class="col-sm-6 col-md-6 col-xl-3">
                <div class="card bg-c-blue bitcoin-wallet">
                    <div class="card-block">
                        ...
                        <h2 class="text-white mb-2 f-w-300">{{ number_format($total_application_fees ?? 0, 2) }} {{ $setting->currency ?? 'BDT' }}</h2>
