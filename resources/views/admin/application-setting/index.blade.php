                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                          <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="fee_amount" class="form-label">{{ __('field_fee_amount') }} ({{ $setting->currency ?? '$' }})</label>
                                <input type="number" step="0.01" class="form-control" name="fee_amount" id="fee_amount" value="{{ isset($row->fee_amount)?$row->fee_amount:'' }}">
                            </div>

                            <div class="form-group col-md-6 mt-4">
                                <div class="switch d-inline m-r-10">
                                    <input type="checkbox" id="pay_online" name="pay_online" value="1" @if(isset($row->pay_online) && $row->pay_online == 1) checked @endif>
                                    <label for="pay_online" class="cr"></label>
                                </div>
                            ...
                            <div class="form-group col-md-6 mt-4">
                                <div class="switch d-inline m-r-10">
                                    <input type="checkbox" id="send_applicant_email" name="send_applicant_email" value="1" @if(isset($row->send_applicant_email) && $row->send_applicant_email == 1) checked @endif>
                                    <label for="send_applicant_email" class="cr"></label>
                                </div>
                                <label>{{ __('Send email to applicant') }}</label>
                            </div>

                            <div class="form-group col-md-6 mt-4">
                                <div class="switch d-inline m-r-10">
                                    <input type="checkbox" id="notify_university_email" name="notify_university_email" value="1" @if(isset($row->notify_university_email) && $row->notify_university_email == 1) checked @endif>
                                    <label for="notify_university_email" class="cr"></label>
                                </div>
                                <label>{{ __('Notify university via mail') }}</label>
                            </div>
