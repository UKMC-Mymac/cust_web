...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('css/prints/library_id_card.css') }}" media="screen, print">
...
<div class="template-container printable">
  <div class="template-inner">
    ...
    <table class="table-no-border">
        <tbody>
            ...
            <tr>
                <td class="temp-logo">
                  <div class="inner">
                    @if(is_file('uploads/student/'.$row->memberable->photo))
                    <img src="{{ asset('uploads/student/'.$row->memberable->photo) }}" alt="Photo">
                    @else
                    <img src="{{ asset('images/user.jpg') }}" alt="Photo">
                    @endif
                  </div>
                </td>
            </tr>
    ...
    <table class="table-no-border">
        <tbody>
            <tr class="meta-data">
                ...
                <td class="value">: {{ $print->prefix ?? '' }}{{ $row->library_id }}</td>
            </tr>
            <tr class="meta-data">
                <td>{{ __('field_member') }} {{ __('field_type') }}</td>
                <td class="value">: {{ __('field_student') }}</td>
            </tr>
            <tr class="meta-data">
                <td>{{ __('field_name') }}</td>
	...
	<script src="{{ asset('plugins/print/js/jQuery.print.min.js') }}"></script>
