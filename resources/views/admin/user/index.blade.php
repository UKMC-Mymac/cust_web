                                ...
                                <tbody>
                                  @foreach( $rows as $key => $row )
                                    <tr>
                                        ...
                                        <td>
                                            <img class="rounded-circle" style="width:40px;" src="{{ asset('uploads/'.$path.'/'.$row->photo) }}" @if($row->gender == 1) onerror="this.src='{{ asset('images/user/avatar-2.jpg') }}';" @else  onerror="this.src='{{ asset('images/user/avatar-1.jpg') }}';" @endif alt="{{ $row->staff_id }}">
                                        </td>
