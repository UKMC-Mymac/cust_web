...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/prints/password.css') }}" media="screen, print">
  ...
  <div class="template-inner">
    ...
    <table class="table-no-border">
        <tbody>
            <tr>
                <td class="temp-title">
                  <h2>{{ __('field_staff_id') }}: {{ $row->staff_id }}</h2>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table-no-border">
        <tbody>
            <tr>
                ...
                <td class="meta-data value">: {{ route('login') }}</td>
