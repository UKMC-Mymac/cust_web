                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-educational-tab" data-bs-toggle="pill" href="#pills-educational" role="tab" aria-controls="pills-educational" aria-selected="false">{{ __('tab_educational_info') }}</a>
                            </li>
                            {{-- <li class="nav-item">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                @if(is_file('uploads/'.$path.'/'.$user->photo))
                                                    <img src="{{ asset('uploads/'.$path.'/'.$user->photo) }}" class="img-fluid field-image" onerror="this.src='{{ asset('images/user/avatar-2.jpg') }}';">
                                                @endif
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                @if(is_file('uploads/'.$path.'/'.$user->signature))
                                                    <img src="{{ asset('uploads/'.$path.'/'.$user->signature) }}" class="img-fluid field-image" onerror="this.src='{{ asset('images/user/avatar-2.jpg') }}';">
                                                @endif
                                                </td>
                                            </tr>
                                            @endif
