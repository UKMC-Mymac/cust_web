                ...
                <div class="card">
                    ...
                    @method('PUT')
                        ...
                        <content class="form-step">
                            ...
                            @endif
                             ...
                             <div class="form-group col-md-3">
                                 ...
                                 <input type="text" class="form-control" name="student_id" id="student_id" value="{{ $row->student_id }}" required>
                             ...
                             <div class="form-group col-md-3">
                                 ...
                                 <select class="form-control" name="batch" id="batch" required>
                                     ...
                                     <option value="{{ $batch->id }}" @if( $row->batch_id == $batch->id) selected @endif>{{ $batch->title }}</option>
                                     @endforeach
                                 </select>
                             ...
                             <div class="form-group col-md-3">
                                 ...
                                 <select class="form-control" name="session" id="session" required>
                                     ...
                                     <option value="{{ $session->id }}" @if( isset($curr_enroll) && $curr_enroll->session_id == $session->id) selected @endif>{{ $session->title }}</option>
                                     @endforeach
                                 </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="relations[]" id="relation" value="{{ $relative->relation }}" required>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="relative_names[]" id="relative_name" value="{{ $relative->name }}" required>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="occupations[]" id="occupation" value="{{ $relative->occupation }}" required>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="relative_phones[]" id="relative_phone" value="{{ $relative->phone }}" required>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="addresses[]" id="address" value="{{ $relative->address }}" required>
                        ...
                        <content class="form-step">
                            ...
                            @endif
                            @if(field('student_bachelor_info')->status == 1)
                            @include('admin.application.inc.file-field', ['name' => 'bachelor_transcript', 'label' => "Bachelor's Transcript", 'file' => $row->bachelor_transcript, 'path' => $path])
                            @include('admin.application.inc.file-field', ['name' => 'bachelor_certificate', 'label' => "Bachelor's Certificate", 'file' => $row->bachelor_certificate, 'path' => $path])
                            @endif
                            @if(field('student_other_edu_info')->status == 1)
                            @include('admin.application.inc.file-field', ['name' => 'other_edu_transcript', 'label' => 'Other Transcript', 'file' => $row->other_edu_transcript, 'path' => $path])
                            @include('admin.application.inc.file-field', ['name' => 'other_edu_certificate', 'label' => 'Other Certificate', 'file' => $row->other_edu_certificate, 'path' => $path])
                            @endif
                            </fieldset>
                            ...
                            <div class="form-group col-md-12 mb-4">
                                <label class="font-weight-bold">{{ __('field_documents') }} ({{ __('field_existing') }})</label>
                                <div class="d-flex flex-wrap gap-3 mt-2">
                                    @foreach($row->documents as $document)
                                        @if(is_file('uploads/'.$path.'/'.$document->attach))
                                            @php
                                                $fileUrl = asset('uploads/'.$path.'/'.$document->attach);
                                                $ext = strtolower(pathinfo($document->attach, PATHINFO_EXTENSION));
                                                $isImageFile = in_array($ext, ['jpg', 'jpeg', 'png', 'gif', 'webp']);
                                            @endphp
                                            <div class="p-2 border rounded bg-light d-inline-block mr-3 mb-3" style="min-width: 200px; max-width: 280px; vertical-align: top;">
                                                <small class="text-muted d-block text-truncate font-weight-bold mb-1" title="{{ $document->title }}">{{ $document->title }}</small>
                                                <a href="{{ $fileUrl }}" target="_blank" class="text-decoration-none">
                                                    @if($isImageFile)
                                                        <img src="{{ $fileUrl }}" alt="{{ $document->title }}" class="img-fluid rounded" style="max-height: 100px; border: 1px solid #e5e9f0; object-fit: contain; background: white;">
                                                    @elseif($ext === 'pdf')
                                                        <span class="badge badge-danger p-2"><i class="fas fa-file-pdf"></i> View PDF</span>
                                                    @elseif(in_array($ext, ['doc', 'docx']))
                                                        <span class="badge badge-primary p-2"><i class="fas fa-file-word"></i> View Word</span>
                                                    @elseif(in_array($ext, ['xls', 'xlsx']))
                                                        <span class="badge badge-success p-2"><i class="fas fa-file-excel"></i> View Excel</span>
                                                    @else
                                                        <span class="badge badge-secondary p-2"><i class="fas fa-file-alt"></i> View {{ strtoupper($ext) }}</span>
                                                    @endif
                                                </a>
                                            </div>
                                        @endif
