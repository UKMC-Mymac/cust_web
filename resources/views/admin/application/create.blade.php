                ...
                <div class="card">
                    ...
                    @csrf
                        ...
                        <content class="form-step">
                            ...
                            <div class="form-group col-md-3">
                                <label for="school_board">Board / University <span>*</span></label>
                                <input type="text" class="form-control" name="school_board" id="school_board" value="{{ old('school_board') }}" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="school_group">Group / Discipline <span>*</span></label>
                                <input type="text" class="form-control" name="school_group" id="school_group" value="{{ old('school_group') }}" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>
                            <div class="form-group col-md-3">
                            ...
                            <div class="form-group col-md-3">
                                <label for="collage_board">Board / University <span>*</span></label>
                                <input type="text" class="form-control" name="collage_board" id="collage_board" value="{{ old('collage_board') }}" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="collage_group">Group / Discipline <span>*</span></label>
                                <input type="text" class="form-control" name="collage_group" id="collage_group" value="{{ old('collage_group') }}" required>
                                <div class="invalid-feedback">This field is required.</div>
                            </div>
                            <div class="form-group col-md-3">
                        ...
                        <content class="form-step">
                            ...
                            <div class="form-group col-md-6">
                                <label for="school_transcript">{{ __('field_school_transcript') }} <span>(Max: 512 KB)</span> <span>*</span></label>
                                <input type="file" class="form-control" name="school_transcript" id="school_transcript" required>
                            ...
                            <div class="form-group col-md-6">
                                <label for="school_certificate">{{ __('field_school_certificate') }} <span>(Max: 512 KB)</span> <span>*</span></label>
                                <input type="file" class="form-control" name="school_certificate" id="school_certificate" required>
                            ...
                            <div class="form-group col-md-6">
                                <label for="collage_transcript">{{ __('field_collage_transcript') }} <span>(Max: 512 KB)</span> <span>*</span></label>
                                <input type="file" class="form-control" name="collage_transcript" id="collage_transcript" required>
                            ...
                            <div class="form-group col-md-6">
                                <label for="collage_certificate">{{ __('field_collage_certificate') }} <span>(Max: 512 KB)</span> <span>*</span></label>
                                <input type="file" class="form-control" name="collage_certificate" id="collage_certificate" required>
                            ...
                            <div class="form-group col-md-6">
                                <label for="photo">{{ __('field_photo') }}: <span>{{ __('image_size', ['height' => 300, 'width' => 300]) }} (Max: 1 MB)</span> <span>*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="signature">{{ __('field_signature') }}: <span>{{ __('image_size', ['height' => 100, 'width' => 300]) }} (Max: 300 KB)</span> <span>*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="national_id_file">NID / Birth Certificate File <span>(Max: 512 KB)</span> <span>*</span></label>
                                <input type="file" class="form-control" name="national_id_file" id="national_id_file" required>
