...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/prints/receipt.css') }}" media="screen, print">
...
@foreach($rows as $row)
<div class="printable">
<div class="template-container" style="width: {{ $print->width }}; height: {{ $print->height }};">
