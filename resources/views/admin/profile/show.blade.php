...
<div class="row">
    <div class="col-md-4">
      ...
      <img src="{{ asset('uploads/'.$path.'/'.$row->photo) }}" class="card-img-top img-fluid profile-thumb" alt="{{ __('field_photo') }}" onerror="this.src='{{ asset('images/user/avatar-2.jpg') }}';">
      @else
      <img src="{{ asset('images/user/avatar-2.jpg') }}" class="card-img-top img-fluid profile-thumb" alt="{{ __('field_photo') }}">
      @endif
      <div class="card-body">
