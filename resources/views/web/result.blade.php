    ...
    <div class="container">
                ...
                <div class="d-flex align-items-center mb-2">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            {{ __('Search and view publication of academic results') }}
                        </small>
                    </div>
                </div>
            </div>
        ...
        <div class="card border rounded-3 shadow-sm mb-4">
            <div class="card-body p-4">
                <form method="GET" action="{{ route('result') }}" class="result-filter-form">
                        ...
                        <div class="col-md-2 d-flex gap-2">
                            <button type="submit" class="btn btn-primary w-100 py-2">
                             ...
                             @if($selected_faculty || $selected_program || $selected_session || $selected_batch)
                                <a href="{{ route('result') }}" class="btn btn-outline-secondary py-2" title="Reset Filters">
