                    ...
                    <div class="header-links">
                        <ul class="header-right-wrap">
                            @if(auth()->guard('web')->check())
                                <li>
                                    <i class="fa-solid fa-user" style="color:black"></i><a style="color:black;" href="{{ route('admin.dashboard.index') }}">Dashboard</a>
                                </li>
                            @else
                                <li>
                                    <i class="fa-solid fa-user" style="color:black" ></i><a style="color:black" href="{{ isset($custom_urls['student_login']) ? $custom_urls['student_login']->resolved_url : '#' }}">Student Login</a>
                                </li>
                                <li>
                                    <i class="fa-solid fa-user-tie" style="color:black" ></i><a style="color:black" href="{{ isset($custom_urls['staff_login']) ? $custom_urls['staff_login']->resolved_url : '#' }}">Staff Login</a>
                                </li>
                            @endif
                           @isset($topbarSetting->email)
                            <li>
                                <a style="color:black" href="mailto:{{ $topbarSetting->email ?? '' }}">
                          ...
                          <li>
                            <a style="color:black" href="tel:{{ $topbarSetting->phone ?? '' }}">
