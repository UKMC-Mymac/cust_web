        ...
        <div class="row justify-content-lg-between justify-content-center align-items-center">
            <div class="col-lg-9 col-12">
                @isset($contentSections['course'])
                    @php $section = $contentSections['course']; @endphp
                            ...
                            <div class="swiper-slide">
                                <article class="program-card">
                                    ...
                                    <div class="program-media">
                                        <a href="{{ $url }}" class="program-media-link" aria-label="{{ $course->title }}">
                                            <img src="{{ asset('uploads/course/' . ($course->attach ?? '')) }}"
                                                 alt="{{ $course->title }}">
                                        </a>

                                        @if(!empty($course->department->title))
                                            <div class="program-chip program-chip--dept">
                                                ...
                                                <span class="program-chip-text">{{ $course->department->title }}</span>
                                            </div>
                                        @endif

                                        @if(!empty($course->accreditation ?? null))
                                    ...
                                    <div class="program-body">
                                        ...
                                        @if(!empty($course->degree_level ?? null))
                                            <span class="program-eyebrow">{{ $course->degree_level }}</span>
                                        @endif

                                        <h3 class="program-title">
                                            <a href="{{ $url }}" title="{{ $rawTitle }}">
                                                {{ $mainTitle }}@if($acronym) <span class="program-title-acronym">({{ $acronym }})</span>@endif
                                            </a>
                                        </h3>

                                        @if(!empty($course->feature_text))
                                            <p class="program-text">{{ $course->feature_text }}</p>
                                        @endif
                                        ...
                                        <div class="program-meta">
                                            @if(!empty($course->credits))
                                                <div class="program-meta-item">
                                                    ...
                                                    <div class="program-meta-text">
                                                        <span class="program-meta-value">{{ $course->credits }}</span>
                                            ...
                                            @if(!empty($course->duration))
                                                <div class="program-meta-item">
                                                    ...
                                                    <div class="program-meta-text">
                                                        <span class="program-meta-value">{{ $course->duration }}</span>
                                                        <span class="program-meta-label">{{ $course->study_mode ?? 'Full-Time' }}</span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        {{-- ---------- CTA ---------- --}}
                                        <a href="{{ $url }}" class="program-btn">
                                            <span class="program-btn-label">{{ $course->cta_text ?? 'Explore Curriculum' }}</span>
