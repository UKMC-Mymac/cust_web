    ...
    <div class="container">
        <div class="row justify-content-lg-between justify-content-center align-items-center">
            @isset($contentSections['campus_life'])
                @php $section = $contentSections['campus_life']; @endphp
        ...
        <div class="slider-area">
            {{-- autoHeight removed so every card is the same height --}}
                    ...
                    @foreach ($campus_lifes as $campusLife)
                        ...
                        <div class="swiper-slide">
                            <article class="campus-card">
                                ...
                                {{-- ============================================
                                     Media — image with overlaid badges
                                     ============================================ --}}
                                <div class="campus-media">
                                    <a href="{{ $url }}" class="campus-media-link"
                                       aria-label="{{ $campusLife->title }}">
                                    ...
                                    @if(!empty($badge))
                                        <span class="campus-chip campus-chip--left">
                                            ...
                                            <span class="campus-chip-text">{{ strtoupper($badge) }}</span>
                                        </span>
                                    @endif
                                ...
                                <div class="campus-body">
                                    ...
                                    {{-- Dark tag line above title --}}
                                    <span class="campus-tag">
                                        {{ strtoupper($campusLife->title) }}
                                    </span>
                                    ...
                                    {{-- Orange eyebrow --}}
                                    @if(!empty($eyebrow))
                                        <span class="campus-eyebrow">{{ $eyebrow }}</span>
                                    @endif

                                    {{-- Serif title --}}
                                    <h3 class="campus-title">
                                        <a href="{{ $url }}">{{ $campusLife->title }}</a>
                                    </h3>

                                    {{-- Description — clamped to keep equal heights --}}
                                    @if(!empty($campusLife->feature_text))
                                        <p class="campus-text">{{ $campusLife->feature_text }}</p>
                                    @endif
