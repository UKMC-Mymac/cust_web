        ...
        <div class="row gy-5 align-items-start">
            ...
            <div class="col-xl-8">
                @isset($contentSections['why_choose_us'])
                    @php $why_choose_us_section = $contentSections['why_choose_us']; @endphp
                    <div class="title-area text-center text-lg-start why-head">
                        ...
                        <h2 class="sec-title text-anim2">{{ $why_choose_us_section->title }}</h2>
                    </div>
                @endisset

                <div class="why-grid">
                    @php $reasons = $why_choose_us->items ?? []; @endphp
                    ...
                    @foreach($reasons as $reason)
                        ...
                        <article class="why-card wow fadeInUp" data-wow-delay="{{ $delay }}s">
                            <div class="why-card-head">
                                <span class="why-number">{{ $number }}</span>
                            ...
                            <a href="{{ $link }}" class="why-card-link">
                                <span>{{ $reason['button_text'] ?? 'Explore More' }}</span>
            ...
            {{-- =========================================================
                 RIGHT — Video, contained & beautifully framed
                 ========================================================= --}}
            <div class="col-xl-4">
                <aside class="why-media">

                    {{-- Glass caption card above the video --}}
                    <div class="why-media-badge">
                        <span class="why-media-badge-dot"></span>
                        <span class="why-media-badge-text">Campus Life</span>
                    </div>

                    {{-- Video frame with locked aspect ratio --}}
                    <div class="why-media-frame">
                        <img src="{{ asset('uploads/why-choose-us/' . $why_choose_us->attach) }}"
                             alt="Why choose us">

                        <div class="why-media-overlay"></div>

                        @if(!empty($why_choose_us->url))
                            <a href="{{ $why_choose_us->url }}"
