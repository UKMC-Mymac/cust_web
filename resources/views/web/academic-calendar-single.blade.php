...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
            <a href="{{ route('academic-calendar') }}" class="text-decoration-none text-dark fw-medium">
                <i class="fa-solid fa-arrow-left me-2"></i>
                {{ __('Back to Academic Calendars') }}
            </a>
                ...
                <div class="bg-white border rounded-4 overflow-hidden shadow-sm">
                    ...
                    @if(!empty($result->attach))
                        @php
                            ...
                            $attachUrl = asset('uploads/academic-calendar/' . $result->attach);
                        @endphp
                ...
                <div class="sticky-lg-top" style="top: 100px;">
                    ...
                    <div class="bg-white border rounded-4 shadow-sm p-4 mb-4">
                        ...
                        <div class="d-grid gap-3">
                            <a href="{{ route('academic-calendar') }}" class="btn btn-dark rounded-3 py-3">
                                <i class="fa-solid fa-calendar-days me-2"></i>
                                {{ __('All Academic Calendars') }}
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="bg-white border rounded-4 shadow-sm p-4">
                            ...
                            <div class="d-flex flex-column gap-3">
                                @foreach($related_results as $related)
                                    <a href="{{ route('academic-calendar.show', ['academicCalendar' => $related->id]) }}" class="text-decoration-none">
