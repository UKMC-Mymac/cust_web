                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="post" action="{{ route('payment.paypal.process') }}">
                                                ...
                                                <button type="submit" class="btn btn-primary btn-sm"><i class="fas fa-money-check"></i> {{ __('btn_pay') }}</button>
                                            </form>
                                            @elseif(config('payment.status') == 'stripe')
                                            <a href="{{ route($route.'.pay', $row->id) }}" class="btn btn-primary btn-sm">
                                                <i class="fas fa-money-check"></i> {{ __('btn_pay') }}
                                            </a>
                                            @elseif(config('payment.status') == 'razorpay')
                                            <form method="post" action="{{ route('payment.razorpay.process') }}">
                                                @csrf
                                                <input type="hidden" name="fee_id" value="{{ $row->id }}">

                                                <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                    data-key="{{ env('RAZORPAY_KEY') }}"
                                                    data-amount="{{ $net_amount * 100 }}"
                                                    data-buttontext="{{ __('btn_pay') }}"
                                            ...
                                            <form method="post" action="{{ route('payment.paystack.process') }}">
                                                @csrf
                                                <input type="hidden" name="fee_id" value="{{ $row->id }}">
                                            ...
                                            <form method="post" action="{{ route('payment.flutterwave.process') }}">
                                                @csrf
                                                <input type="hidden" name="fee_id" value="{{ $row->id }}">

                                                <button type="submit" class="btn btn-primary btn-sm"><i class="fas fa-money-check"></i> {{ __('btn_pay') }}</button>
                                            </form>
                                            @elseif(config('payment.status') == 'bkash')
                                            <form method="post" action="{{ route('payment.bkash.process') }}">
                                                @csrf
                                                <input type="hidden" name="fee_id" value="{{ $row->id }}">
                                                <input type="hidden" name="payment_type" value="fees">
                                                <button type="submit" class="btn btn-primary btn-sm"><i class="fas fa-money-check"></i> {{ __('btn_pay') }}</button>
                                            </form>
                                            @elseif(config('payment.status') == 'nagad')
                                            <form method="post" action="{{ route('payment.nagad.process') }}">
                                                @csrf
                                                <input type="hidden" name="fee_id" value="{{ $row->id }}">
                                                <input type="hidden" name="payment_type" value="fees">
                                                <button type="submit" class="btn btn-primary btn-sm"><i class="fas fa-money-check"></i> {{ __('btn_pay') }}</button>
                                            </form>
                                            @elseif(config('payment.status') == 'sslcommerz')
                                            <form method="post" action="{{ route('payment.sslcommerz.process') }}">
                                                @csrf
                                                <input type="hidden" name="fee_id" value="{{ $row->id }}">
                                                <input type="hidden" name="payment_type" value="fees">
                                                <button type="submit" class="btn btn-primary btn-sm"><i class="fas fa-money-check"></i> {{ __('btn_pay') }}</button>
